  ...
  project: [
    {
      name: 'Costa-Admin',
      briefIntro:
        'A mock employee admin panel. Angular 6, Angular Material, and TypeScript.',
      img: 'dashboard',
      paragraph:
        'A mock employee admin panel. Angular 6, Angular Material, Flex-Layout, Chart.js, and TypeScript.',
      link: 'https://abecel22.github.io/costa-admin/',
    ...
    },
    {
      ...
      briefIntro:
        'Learn about anything through this Wikipedia viewer. React, SCSS, and Gatsby SSG.',
      img: 'wiki',
      paragraph:
        'Learn about anything through this Wikipedia viewer. Features includes a keyterm search and a random article generator. React, SCSS, and Gatsby SSG.',
      link: 'http://costa-wiki.surge.sh/',
